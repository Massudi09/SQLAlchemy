...
def home():
    return (
        f"<p>Aloha and Welcome to the Hawaii weather API!!!</p>"
        f"Available Routes:<br/>"
        f"<br/>"
        f"/api/v1.0/precipitation<br/> List of precipitation data between 8/23/16 and 8/23/17 for all stations<br/><br/>"
        f"/api/v1.0/stations<br/> List of all weather stations and locations<br/><br/>"
        f"/api/v1.0/tobs<br/>List of the Temperature Observations for each station <br/><br/>"
        f"/api/v1.0/start<br/>Calculates the minimum, average, and max temperatures between a given date and 8/23/17<br/><br/>."
        f"/api/v1.0/start_date/end_date<br/>RCalculates the minimum, average, and max temperatures between given start and end dates<<br/><br/>."
    )
